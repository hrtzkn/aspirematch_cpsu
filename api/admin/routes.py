...
def download_result(exam_id):
    ...
    url = request.host_url + f"admin/adminSurveyResultPDF/{exam_id}"
    ...
    return send_file(
        BytesIO(pdf_bytes),
        as_attachment=True,
        download_name=f"Career_Interest_Result_{exam_id}_{student_data['fullname']}.pdf",
        mimetype="application/pdf"
    )

@admin_bp.route('/adminSurveyResultPDF/<exam_id>')
def adminSurveyResultPDF(exam_id):
...
def download_admin_inventory_pdf(student_id):
    ...
    url = request.host_url + f"admin/adminInventoryResultPDF/{student_id}"
...
@admin_bp.route('/adminInventoryResultPDF/<int:student_id>')
def adminInventoryResultPDF(student_id):
